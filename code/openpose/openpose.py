...
image_dir = '/content/gdrive/MyDrive/Awone/dataset/images/image_frames_rebound_2K/'
...
test_bbox = df[df['frame'] >= train_size][['x1', 'y1', 'x2', 'y2']].values
